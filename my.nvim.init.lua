...
require('lazy').setup({
  ...
  -- { import = 'custom.plugins' },
  {
    ...
    config=function()
      vim.keymap.set('n', '<leader>n', function() vim.cmd('Neotree') end)
      vim.keymap.set('n', '<leader>m', function() vim.cmd('Neotree dir=.') end)
...
-- To revisit this config
vim.keymap.set('n', '<leader>vi', function() vim.cmd('e ~/.config/nvim/init.lua') end)
